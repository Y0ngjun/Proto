...
- **Create Primitive**: Edit 모드에서 "Create Primitive" 드롭다운 버튼으로 Cube, Sphere, Plane, Cylinder를 빠르게 생성합니다.
...
- **Context Menu**: 우클릭으로 "Create Empty", 기본 메쉬(Cube, Sphere, Plane, Cylinder) 생성, 및 선택한 객체의 삭제, 이름 변경이 가능합니다.
